...
CREATE TABLE company_followers (
    ...
    CONSTRAINT fk_followers_company FOREIGN KEY (company_id) REFERENCES companies(id) ON DELETE CASCADE
);
...
CREATE TABLE interview_experiences (
    ...
    year_of_interview INTEGER NOT NULL,
    is_selected BOOLEAN NOT NULL,
    status VARCHAR(20) NOT NULL DEFAULT 'PENDING' CHECK (status IN ('PENDING', 'APPROVED', 'REJECTED')),
    upvote_count INTEGER NOT NULL DEFAULT 0,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_experiences_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
    CONSTRAINT fk_experiences_company FOREIGN KEY (company_id) REFERENCES companies(id) ON DELETE CASCADE
);
...
CREATE INDEX idx_experiences_role ON interview_experiences(role);

-- ----------------------------------------------------------------------------
-- Table: interview_experience_stages
-- ----------------------------------------------------------------------------
CREATE TABLE interview_experience_stages (
    ...
    CONSTRAINT fk_stages_experience FOREIGN KEY (experience_id) REFERENCES interview_experiences(id) ON DELETE CASCADE
);

CREATE INDEX idx_stages_experience ON interview_experience_stages(experience_id);
...
CREATE TABLE experience_upvotes (
    ...
    CONSTRAINT fk_upvotes_experience FOREIGN KEY (experience_id) REFERENCES interview_experiences(id) ON DELETE CASCADE
);
